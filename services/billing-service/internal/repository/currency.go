...
// leaves a tenant with rupee invoices and dollar invoices sitting side by side,
...
// invoice line does not depend on another service being reachable. The pin is
// written when the tenant's first invoice states its currency.
...
// This is what the first invoice for a tenant calls.
